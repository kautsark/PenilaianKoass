...
@section('content')
 <div class="page-inner">
    <h4 class="page-title"> Add Pengajar (Dosen)</h4>
    <div class="page-category"> Create Pengajar </div>
      <div class="row">
        <div class="col-md-12">
          <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="nrp_dosen" id="nrp_dosen" class="form-control @error ('nrp_dosen') is-invalid @enderror" autofocus placeholder="NRP Pengajar" value="{{ old('nrp_dosen') }}">
                    @error('nrp_dosen')
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="nama_dosen_pengajar" id="nama_dosen_pengajar" class="form-control @error('nama_dosen_pengajar') is-invalid @enderror" placeholder="Nama Pengajar" value="{{ old('nama_dosen_pengajar') }}">
                ...
                <div class="row">
                  <div class="form-group col-md-3">
                    ...
                    <textarea name="alamat_dosen" class="form-control @error('alamat_dosen') is-invalid @enderror"  placeholder="Alamat Pengajar" id="" cols="15" rows="3">{{ old('alamat_dosen') }}</textarea>
                    @error('alamat_dosen')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="no_telp_hp" id="no_telp_hp" class="form-control  @error('no_telp_hp') is-invalid @enderror" placeholder="No Telp Pengajar" value="{{ old('no_telp_hp') }}">
                    @error('no_telp_hp')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="date" name="tanggal_masuk_rs" id="tanggal_masuk_rs" class="form-control @error('tanggal_masuk_rs') is-invalid @enderror" placeholder="Email Pengajar" value="{{ old('tanggal_masuk_rs') }}">
